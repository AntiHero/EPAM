...
public class ProgramTester {
    public static void maxElementTest() {
        ...
        String result = "Max value in array " + Arrays.toString(array) + " is: "
                + OneDimentionalArray.findMaxElement(array);
        View.print(result);
    }
    ...
    public static void minElementTest() {
        ...
        String result = "\nMin value in array " + Arrays.toString(array) + " is: "
                            + OneDimentionalArray.findMinElement(array);
        View.print(result);
    }
