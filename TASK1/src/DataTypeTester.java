...
public class DataTypeTester {
    ...
    public static void testChar() {
        ...
        System.out.println("in hex form:");
        System.out.printf("-0x%x = 0x%x ", a & 0xFFFF, c & 0xFFFF);
    ...
    public static void testInt() {
        ...
        System.out.println("in binary form:");
        c = temp;
        System.out.printf("%s |= %s --> c = %s\n", Integer.toBinaryString(c), Integer.toBinaryString(a),
        ...
        System.out.println("in binary form:");
        c = temp;
        System.out.printf("%s >>= %s --> c = %s\n", Integer.toBinaryString(c), Integer.toBinaryString(1),
    ...
    public static void testLong() {
        ...
        System.out.println("in binary form:");
        c = temp;
        System.out.printf("%s |= %s --> c = %s\n", Long.toBinaryString(c), Long.toBinaryString(a),
        ...
        System.out.println("in binary form:");
        c = temp;
        System.out.printf("%s >>= %s --> c = %s\n", Long.toBinaryString(c), Long.toBinaryString(1),
    ...
    public static void testAnimal() {
        ...
        System.out.print(
                "Upcasting: subclass (Animal) to superclass (Creature):\nAnimal Rabbit = new Animal(\"Moony\")\n");
