...
public class CarFleetLogic {
    ...
    public static void sortTrucksByCapacity(CarFleet carFleet) {
        Sorter.sortTrucksByCapacityAsc(carFleet);
    }

    public static void sortTruckByMassInsertion(CarFleet carFleet) {
        Sorter.sortTrucksByMassAscInsertionSort(carFleet);
    }

    public static void sortTruckByMassSelection(CarFleet carFleet) {
        Sorter.sortTrucksByMassAscSelectionSort(carFleet);
    }

    public static void sortTruckByMassMerge(CarFleet carFleet) {
        Sorter.sortTrucksByMassAscMergeSort(carFleet);
    }

    public static void searchCarByMass(CarFleet carFleet, int index) {
        int result = Search.searchTruckMassBinary(carFleet, index);

        if (result >= 0) {
            View.print("Truck is found! \n" + carFleet.getContainer().getTruck(result));
        } else {
            View.print("Truck is not found!");
        }
    }
