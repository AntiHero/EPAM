...
public class Container {
    ...
    public int getTruckNumber() {
        ...
        return heavyCars.size();
    }
    
    public int getLightVehicleNumber() {
        if (fixed) {
            return lightVehicles.length;
        }
        return lightCars.size();
    }
    ...
    public void addLightVehicleDynamic(LightVehicle lightVehicle) {
        lightCars.add(lightVehicle);
    }
    
    public void setLightVehicleDynamic(LightVehicle lightVehicle, int index) {
        lightCars.set(index, lightVehicle);
    }
    
    public void removeLightVehicleDynamic(int index) {
    ...
    public void addTruckDynamic(Truck truck) {
        heavyCars.add(truck);
    }
    
    public void setTruckDynamic(Truck truck, int index) {
        heavyCars.set(index, truck);
    }
